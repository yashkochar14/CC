...
const Update = ({ match }) => {
  ...
  useEffect(() => {
    axios.get(`https://mern-mvc-project.onrender.com/api/books/${match.params._id}`).then(response => {
  ...
  useEffect(() => {
    axios.get('https://mern-mvc-project.onrender.com/api/authors/').then(response => {
      setAuthors(
  ...
  const handleFormSubmission = () => {
    axios
      .put(`https://mern-mvc-project.onrender.com/api/books/${match.params._id}`, book)
